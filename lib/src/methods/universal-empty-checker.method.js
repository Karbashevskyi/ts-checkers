...
function UniversalEmptyCheckerMethod(value) {
    ...
    if ((0, boolean_method_1.BooleanMethod)(value)) {
        return false;
    }
    // If value is number when is not empty
    if ((0, number_method_1.NumberMethod)(value)) {
        return false;
    }
    // If value is BigInt when is not empty
    if ((0, bigint_method_1.BigintMethod)(value)) {
        return false;
    }
    // If value is Function when is not empty
    if ((0, function_method_1.FunctionMethod)(value)) {
        return false;
    }
    return ((_a = Object.keys(value)) === null || _a === void 0 ? void 0 : _a.length) === 0;
}
